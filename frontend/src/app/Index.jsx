    ...
    return (
        <div className={'app-container' + (user && ' bg-light')}>
            ...
            <Switch>
                ...
                <PrivateRoute exact path="/home" roles= {[Role.User,Role.FreeLancer,Role.Both,Role.Admin]}component={Home} />
                <PrivateRoute path="/profile"  roles= {[Role.User,Role.Both,Role.FreeLancer,Role.Admin]} component={Profile} />
