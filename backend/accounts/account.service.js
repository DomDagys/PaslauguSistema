...
async function sendVerificationEmail(account, origin) {
    ...
    if (origin) {
        ...
        message = `<p>Paspauskite nuorodą:</p>
    ...
    await sendEmail({
        to: account.email,
        subject: 'Paslaugų Sistema - el.pašto patvirtinimas',
        html: `<h4>Patvirtinti el.paštą/h4>
...
async function sendAlreadyRegisteredEmail(email, origin) {
    ...
    await sendEmail({
        to: email,
        subject: 'Paslaugų Sistema - El paštas jau užregistruotas',
        html: `<h4>Toks El.Paštas jau registruotas</h4>
               <p>Jūsų el.paštas <strong>${email}</strong> jau yra mūsų sistemoje</p>
               ${message}`
    });
}
...
async function sendPasswordResetEmail(account, origin) {
    ...
    if (origin) {
        ...
        message = `<p>Paspauskite nuorodą žemiau, kad atstatytumėte slaptažodį</p>
    ...
    await sendEmail({
        to: account.email,
        subject: 'Paslaugų Sistema - slaptažodžio atstatymas',
