...
function getSuspendedPosts(req, res, next) {
    suspensionService.getSuspendedPosts()
...
function removePostSuspension(req, res, next) {
    let { id } = req.body;
    suspensionService.removePostSuspension(id)
...
function removePost(req, res, next) {
    ...
    suspensionService.removePost(postId)
...
function suspendUser(req, res, next) {
    ...
    suspensionService.suspendUser(accountId, adminName)
        .then(dat => res.json({ message: "Vartotojas suspenduotas."}))
        .catch(next);
}
...
function removeUserSuspension(req, res, next) {
    ...
    suspensionService.removeUserSuspension(suspensionId, accountId)
